 ...
 *
 */
public class BridgedNWSGraphGenerator implements GraphGenerator{
    /** 頂点数 */
     ...
     */
    public BridgedNWSGraphGenerator(int vertexCount1, double possibility1, int k1, int vertexCount2, double possibility2, int k2) {
    ...
    public BridgedNWSGraphGenerator(int vertexCount){
    ...
    public MyGraph<MyVertex, MyEdge> create() throws ParserConfigurationException, SAXException, IOException {
        ...
        GraphGenerator gg1 = new NWSGraphGenerator(vertexCount1, p1, k1);
        GraphGenerator gg2 = new NWSGraphGenerator(vertexCount2, p2, k2);
